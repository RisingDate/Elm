...
params = {
    ...
    'model_path': '../models/tf-model3.pth',
    'scaler_path': '../models/tf-scaler3.pkl',
    'save_txt_path': '../results/B/output-250514-4-tf.txt',
    'save_csv_path': '../results/B/output-250514-4-tf.csv'
}
