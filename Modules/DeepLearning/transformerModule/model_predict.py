...
params = {
    ...
    'model_path': '../models/tf-model1.pth',
    'scaler_path': '../models/tf-scaler1.pkl',
    'save_txt_path': '../results/B/output-250514-2-tf.txt',
    'save_csv_path': '../results/B/output-250514-2-tf.csv'
}
